...
public class SpringTut003 {

    private static final Logger log = Logger.getLogger(SpringTut003.class);


    public static void main(String[] args) {

        ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("beans-applicationContext.xml");
        ...
        Coach thirdCoach = ctx.getBean("thirdCoach", TrackCoach.class);
